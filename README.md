...
## 📋 Detail Tugas
<<<<<<< HEAD
Pada halaman utama website, peserta diminta untuk menyertakan elemen-elemen berikut:
1. **Header** yang berisi navigasi utama.
2. **Hero section** dengan deskripsi singkat dan menarik.
3. **Section layanan, produk, atau konten utama** yang relevan.
4. **Section testimoni atau informasi tambahan** (opsional).
5. **Formulir kontak sederhana** untuk pengunjung.
6. **Footer** yang memuat informasi pelengkap.

Peserta juga diperbolehkan untuk menambahkan elemen atau struktur lainnya sesuai kebutuhan untuk memperkaya tampilan dan fungsi halaman.
...
![Screenshot Tampilan HTML](ss.png)
=======
